...
from bonaparte.docstring import GoogleDocstring, NumpyDocstring
from bonaparte.export import export_to_yaml, log_error
...
class Config(object):
    ...
    sure that "bonaparte" is enabled in `conf.py`::

        # conf.py

        # Add any Sphinx extension module names here, as strings
        extensions = ['bonaparte']
...
def _process_docstring(app, what, name, obj, options, lines):
    ...
    * ``napoleon_numpy_docstring`` -- parse NumPy style docstrings
    ...
    if what in ["class", "function", "method"]:
        export_to_yaml( what, name, obj, lines)
